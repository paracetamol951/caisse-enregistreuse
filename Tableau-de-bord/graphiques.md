...
La page « Rapports » vous permet de piloter efficacement votre activité grâce à une série complète de tableaux et graphiques. Vous pouvez consulter, exporter ou archiver vos données selon différents formats.
...
Ce format est recommandé pour une lecture humaine : plus lisible, plus condensé, il offre une vue claire de vos performances.
...
Vous pouvez obtenir un rapport détaillé pour un utilisateur particulier : vendeur, manager ou administrateur.
...
- Chiffres récapitulatifs généraux
- Rapport par taux de TVA
- Table des ventes
- Ventes quotidiennes
- Sorties de caisse
- Erreurs de fermeture de caisse
- Graphique des ventes dans le temps
- Graphique du nombre de ventes par jour
- Fermetures de caisse
- Rapport des caisses
- Rapport des clients
- Rapport des utilisateurs
- Rapport des rayons et groupes de rayons
