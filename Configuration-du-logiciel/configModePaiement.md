...
Appuyez sur Entrée pour valider. Les modifications sont automatiquement enregistrées.
...
- Note : ajoute une note non imprimée au ticket, visible dans l'historique
- Client : associe un client à la commande
- Facture email / SMS / courrier postal : envoie la facture au client par le canal sélectionné
