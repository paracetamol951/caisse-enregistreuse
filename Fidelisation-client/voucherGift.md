...
Le logiciel permet de créer, imprimer et utiliser des chèques cadeaux, pour proposer une solution de paiement flexible et fidélisante.
...
Un reçu contenant le chèque cadeau est imprimé automatiquement après l'opération.
...
- Un chèque cadeau peut être utilisé en une seule ou plusieurs fois, selon la configuration définie.
- Il est refusé s'il est épuisé, annulé, remboursé ou non encore réglé.

## Suivi des chèques cadeaux

Depuis l'interface de gestion, vous pouvez consulter la liste complète des chèques cadeaux émis, avec leur statut, leur montant, leur date de création et leur historique d'utilisation.
