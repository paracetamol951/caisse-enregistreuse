...
? Si vous utilisez le système de fidélité, les tags NFC permettent d'identifier rapidement un client et d'accéder à son profil : points de fidélité, avoirs, créances, etc.

? Les tags NFC peuvent également être utilisés pour l'identification des utilisateurs (vendeurs, managers). Il suffit de scanner une carte ou un téléphone compatible pour se connecter.

Un même tag NFC peut être associé à un client ou à un utilisateur du logiciel.
...
- Lors de la création ou modification d'un client, scanner un tag NFC permet de l'attacher directement à ce client.
- Depuis l'interface de caisse, scanner un tag inconnu fait apparaître une fenêtre de choix pour l'attacher à un client ou un utilisateur.
- Scanner un tag NFC enregistré d'un client l'associe automatiquement à la commande en cours.
- Scanner un tag NFC enregistré d'un utilisateur permet de s'identifier automatiquement dans le système.
