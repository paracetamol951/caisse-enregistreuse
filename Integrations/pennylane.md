...
- <a href="https://pennylane.com?downloadInvoice=1" rel="nofollow">Disposer d?un compte PennyLane actif</a>
- Avoir accès aux paramètres de configuration dans Kash.Click

## 3. Connexion du compte PennyLane
...
## 4. Autorisation et import des données historiques
...
## 5. Événements générant des écritures comptables
...
### 5.1 Enregistrement d?une commande
