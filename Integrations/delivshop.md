...
Depuis la page **Configuration \> Livreurs**, les administrateurs peuvent :

- Accepter ou refuser une candidature
- Révoquer un livreur déjà accepté
- Consulter les informations du livreur
- Voir le nombre de livraisons effectuées

## Utilisation par le livreur

Une fois accepté, le livreur peut consulter la liste des commandes à livrer pour chaque boutique autorisée.
