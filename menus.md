...
?? La gestion des menus permet d'assigner un prix fixe à un ensemble d'articles provenant de rayons spécifiques.

## Principe de fonctionnement

Un menu est composé de plusieurs articles, chacun devant appartenir à un rayon prédéfini.
...
? Si plusieurs menus sont applicables, le logiciel appliquera celui qui est positionné en premier dans la page de configuration.
