...
Kash.click vous permet de générer des factures au format PDF, incluant les données sous format Factur-X. Ce format permet d'intégrer les lignes d'articles, ainsi que les taux et montants de TVA dans un fichier PDF enrichi.
