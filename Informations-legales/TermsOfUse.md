## 1. Eligibilité à un compte

1.  Vous devez avoir 18 ans ou plus, ou l\'age de la majorité de la juridiction dans laquelle vous résidez afin d\'utiliser ce service.
...
Si nous avons besoin de vous contacter, nous vous enverrons un email.
...
Vous devez lire, et accepter tous les termes et conditions contenus dans ces conditions d\'utilisation ainsi que dans la politique de confidentialité avant de devenir un membre de caisse.enregistreuse.fr.

1.  Le support technique est uniquement disponible pour les utilisateurs disposant d\'une licence Premium étendue via une interface intégrée dans la page Aide du logiciel.
2.  Les présentes conditions d\'utilisation sont gouvernées et interprétées en accord avec les lois Françaises. Les partis consentent de manière irrévoquable et inconditionnelle de soumettre exclusivement à la cour de Paris toute dispute ou conflit en rapport avec nos conditions d\'utilisation.
3.  Vous acceptez le fait que caisse.enregistreuse.fr puisse à tout moment amender ces conditions d\'utilisation en postant ces amendements sur le site web de l\'application en page d\'aide. Les conditions d\'utilisation prennent effet dès leur publication. La simple utilisation de nos services signifie l\'acceptation de nos conditions d\'utilisation. Si vous n\'acceptez pas les présentes conditions d\'utilisation ou ses amendements, il n\'est pas autorisé de continuer à utiliser nos services.
4.  Il n\'est pas autorisé d\'utiliser caisse.enregistreuse.fr pour quelque activité contraire aux lois en vigueur dans votre juridiction (ce qui inlut mais ne se limite pas aux droits d\'auteurs).
5.  Vous acceptez de ne pas reproduire, dupliquer, copier, vendre ou revendre n\'importe quelle portion de ce service, utilisation de ce service ou accès au service sans l\'autorisation de caisse.enregistreuse.fr.
6.  Vous ne devez pas acheter le traffic des moteurs de recherche ou autre traffic acheté au clic (tel que Google Adwords) ou des noms de domaines qui utilisent les marques de caisse.enregistreuse.fr ou des variations / fautes de frappes
...
Si une dispute survient, le problème sera jugé en France.

Si certains contenus peuvent être transférés sans encryption, vos informations de paiement seront toujours transférées de manière sécurisée.

## 4. Droits accordés à caisse.enregistreuse.fr

1.  Nous nous réservons le droit de modifier ou mettre un terme au service for quelconque raison, sans avertissement préalable.
...
En cas de conflit de propriété concernant un compte de caisse.enregistreuse.fr, nous pouvons geler le compte ou le transférer au propriétaire légitime.
...
## 7. Propriété intellectuelle et contenu client

1.  Nous ne revendiquons aucun droit de propriété intellectuelle sur les données fournies au service de Caisse.enregistreuse.fr. Tout les données que vous enregistrez sur le site reste les vôtres. Vous pouvez supprimer votre boutique Caisse.enregistreuse.fr à tout moment en supprimant votre compte.
2.  En activant la fonctionnalité de boutique en ligne, vous acceptez: (a) d\'autoriser d\'autres utilisateurs Internet à visualiser votre contenu de boutique; (b) permettre à la Caisse.enregistreuse.fr d\'afficher et de stocker le contenu de votre magasin; et (c) Caisse.enregistreuse.fr peut, à tout moment, examiner tout le contenu de la boutique que vous avez soumis à son service.
3.   Vous conservez la propriété de tout le contenu de la boutique que vous avez paramétré dans Caisse.enregistreuse.fr; Cependant, en rendant votre boutique publique, vous acceptez d\'autoriser les autres utilisateurs à visualiser votre contenu. Vous êtes responsable de la conformité du contenu du magasin avec toutes les lois ou tous les règlements applicables.
...
## 12. Notice DMCA et procédure de retrait
