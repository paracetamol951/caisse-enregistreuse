...
Le logiciel permet d\'associer à chaque client des crédits (avoirs) ou des dettes (créances), facilitant ainsi les remboursements différés ou les paiements à crédit.
...
Si une commande est enregistrée sans paiement immédiat mais associée à un client, le montant est enregistré comme une dette.

Depuis la page de configuration des clients, vous pouvez consulter la dette de chaque client via la colonne dédiée.

## Consulter et régulariser les dettes
