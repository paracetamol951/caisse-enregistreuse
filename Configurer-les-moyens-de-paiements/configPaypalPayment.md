...
- Dans la boutique en ligne : les clients saisissent leur numéro de carte pour payer leur commande.
- Dans la caisse : il vous faudra saisir manuellement le numéro de carte du client dans la fenêtre de paiement PayPal.

## Configuration du paiement PayPal
...
Si vous souhaitez recevoir des notifications automatiques de confirmation de paiement, veuillez contacter notre service client pour activer les notifications IPN.
