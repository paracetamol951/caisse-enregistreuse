...
Pour utiliser cette option, activez-la depuis la page de configuration.

## Définition des durées de préparation

Une fois activée, vous pouvez saisir un temps de préparation (en secondes) pour chaque article.
