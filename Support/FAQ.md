## Questions fréquentes {#questions-fréquentes .line}
...
Sur ordinateur, il n\'est pas nécessaire de cliquer sur le bandeau, il suffit de saisir sa recherche au clavier, de même si vous avez un clavier connecté à votre tablette
...
Il ne faut pas calculer la TVA totale en se basant sur les totaux par TVA, mais il faut bien faire la somme de la TVA de chaque commande.
...
Le logiciel se deconnecte tout le temps et des ventes se cumulent sur l autres caisses C est problématique et énervant quel est la solution
...
Problème avec un achat de licence
...
Impression auto ticket de caisse
...
Je ne retrouve plus mes données dans les rapports
...
Obtention de devis au lieu de factures
...
Pouvez vous m\'indiquer le nombre maximum de clients que l\'on peut rentrer dans le logiciel ?
...
Problèmes de lecture de codes barres lecteur Inateck
...
Pb connexion d\'une imprimante TM-T20
...
Date de création - date de valeur
...
Je n\'arrive pas à valider mon fond de caisse à zéro
...
Il y a plus de 2500 articles, je ne trouve pas certains articles
...
Adresse personnalisée boutique en ligne
...
Correspondance articles avec prestashop
...
Pour télécharger votre facture, vous devez en premier lieu renseigner votre numéro de RC et numéro de TVA (ou \"OutsideEU\" si hors EU) dans la page Configuration, Options générales du site.\
Une fois ces informations configurées, vos factures seront automatiquement dans la page Licence du logiciel (tout en bas de page).
...
Droits administrateur pour remboursement
...
valider la commande le jour du paiement
...
Changement du montant de fond de caisse
...
Effacer l\'historique de la caisse.
...
Amélioration sur recherche d\'article pour l\'encaissement
...
Application pour les tablettes
...
Tablette android usb et tm t2011
...
Impression Bluetooth du ticket de caisse sous Android
...
Lien internet sur ticket caisse
...
Toujours la pub sur le ticket de caisse
...
Longueur des tickets de caisse : problème d\'impression
...
Le rapport instantané affiche les grands totaux
...
Mise à jour de la boutique prestashop
...
Imprimer son ticket à chaque encaissement
...
Paypal ne me propose pas de payer
