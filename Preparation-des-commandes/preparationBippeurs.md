...
Pour activer la gestion des bippeurs, allez dans la page **Configuration \> Commandes**
...
Dans la page de préparation, vous verrez la liste des commandes en attente ainsi que le numéro de bippeur associé à chacune.

Lorsque la préparation est terminée, vous pouvez activer le bippeur pour prévenir le client.
