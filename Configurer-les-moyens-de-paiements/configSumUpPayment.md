# Configurer les paiements CB avec SumUp

SumUp permet d'accepter les paiements par carte bancaire (CB, Visa, Mastercard...) avec un petit terminal connecté à votre smartphone ou tablette.

Notre logiciel est compatible avec SumUp sur Android et iOS.
...
<a href="https://sumup.fr/caisseenregistreuse/" class="button green">Ouvrir un compte SumUp</a>
