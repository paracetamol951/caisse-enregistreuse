...
Vous pouvez activer un système de points de fidélité utilisables comme moyen de paiement dans la caisse.
...
Le nombre de points disponibles pour chaque client est automatiquement affiché en pied de page de chaque ticket de caisse.

## Paiement avec les points de fidélité

Pour permettre à vos clients de payer avec leurs points de fidélité, vous devez ajouter une action spécifique dans la configuration.
