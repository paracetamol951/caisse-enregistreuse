...
Voir les vidéos](https://www.youtube.com/watch?v=ZwdTNen9bPI&list=PLPIgp_AMNZhO0xY85tpdsgzQMLlZW1q_8){#linkYoutube target="_blank"}
...
[Caisse enregistreuse](https://caisse.enregistreuse.fr){target="_blank"}\
\
...
\
[Fiche App Store Application caisse enregistreuse](https://itunes.apple.com/fr/app/caisse-enregistreuse/id1259175837?mt=8&downloadInvoice=1){target="_blank"}\
L\'application ajoute au logiciel les fonctionnalités suivantes :\
- lecture des codes barres à l\'aide de la caméra de l\'appareil\
- paiement avec le terminal de paiement SumUp\
- gestion de l\'impression avec l\'imprimante de ticket portable\
