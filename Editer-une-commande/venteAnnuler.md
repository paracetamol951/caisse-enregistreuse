...
- Si un montant est en cours de saisie au pavé numérique, celui-ci est effacé.
- Si un multiplicateur est saisi, il est réinitialisé à 1.
- Si un filtre est appliqué sur les rayons, il est supprimé.
- Si l'utilisateur le confirme, la commande en cours est entièrement annulée.
