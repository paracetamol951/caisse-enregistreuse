...
`49.9?, paiement comptant en espèces`{.actionCode}
...
`18? dans rayon 2, paiement CB`{.actionCode}
...
`3x Article 1, paiement comptant en espèces`{.actionCode}
...
`paiement Article 3 avec un billet de 10?`{.actionCode}
...
`remboursement Article 2 en espèces`{.actionCode}
...
`réduction de 10% sur Article 2 + Article 3`{.actionCode}
...
`Article 4 + Article 6 dans un menu à 10?`{.actionCode}
...
`Paiement de 10? en CB + 5 euros espèces`{.actionCode}
