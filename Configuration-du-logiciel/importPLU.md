...
- Les entrées présentes dans la base mais absentes du fichier (option de suppression)

? Vous pourrez choisir, indépendamment, les actions à effectuer : ajouter uniquement, mettre à jour uniquement, ou supprimer également les éléments absents.
