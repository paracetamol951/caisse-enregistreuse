...
- Import CSV contenant votre liste de clients
- Import automatique du carnet de contacts Android
- Enregistrement par le client lui-même via la boutique en ligne
- Ajout automatisé via les webservices
- Import Prestashop ou synchronisation automatique avec WooCommerce

## Champs disponibles pour un client
...
- Code-barres ou tag NFC associé
- Préférences pour facturation/marketing par SMS ou email
- Mandat de prélèvement SEPA pour règlements ultérieurs
...
- **Marketing:** total des paiements, jour préféré, articles les plus achetés sur 3 mois.
- **Cartes de fidélité:** consultation des cartes en cours.
