...
Utilisez le pavé numérique pour entrer rapidement des quantités ou effectuer des calculs simples :

- Touches 0 à 9 : saisie numérique
- Touche + : addition
...
3.  Clients
4.  Points de retrait (si activés)
...
Les raccourcis \$ permettent d'accéder directement à certaines sections :
  ...
  Raccourci   Action
  ----------- ---------------------------------------------
  \$0         Accès à la liste des articles
  \$1         Accès à la liste des rayons
  \$2         Accès à la liste des utilisateurs connectés
  \$3         Accès à la liste des clients
  \$4         Accès à la liste des réductions
  \$5         Accès à la liste des bons de réduction
